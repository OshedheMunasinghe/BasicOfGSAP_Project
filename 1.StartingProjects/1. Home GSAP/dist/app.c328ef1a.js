...
var imgNav = document.querySelectorAll('nav img');
var title = document.querySelector('h1');
var verticalLine = document.querySelector('.middle-line');
var grapesLogo = document.querySelector('.home-content img');
var homeBtn = document.querySelector('.home-content button'); //reveal animation, when the windows has fully finish loading then start the animation

window.addEventListener('load', reveralAnim);

function reveralAnim() {
  var TLFADE = _gsap.gsap.timeline();
